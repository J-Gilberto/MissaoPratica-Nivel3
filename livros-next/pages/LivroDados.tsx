...
const LivroDados = () => {
  ...
  return (
    ...
    <main style={{ fontFamily: 'Times New Roman', fontStyle: 'italic', fontSize: '20px', textShadow: '2px 2px 2px red'}}>        
      <div className="container">
        <h1 style={{ textShadow: '4px 4px 4px black' }} className="text-center mt-5">Adicionando Livros</h1>
        <form onSubmit={incluir} className=" mt-9">
          <div className="mb-3">
