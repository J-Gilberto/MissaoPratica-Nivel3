...
const LivroDados = () => {
    ...
    return (
        <main style={{ fontFamily: 'Times New Roman', fontSize: '20px', fontStyle: 'italic'}}>
            <div className='container'>
                <h1 className="titulo-left" style={{ marginBottom: '40px', textShadow: '2px 2px 4px red'}}>Dados do Livro</h1>
